...
/***/function (module, exports, __webpack_require__) {
	...
	$(document).on('scroll', function () {
		...
		if ($scrollTop > $constHeight) $stickyEl.addClass('flag-sticky', 2000, 'easeInOutQuad');else $stickyEl.removeClass('flag-sticky', 2000, 'easeInOutQuad');
...
/***/function (module, exports) {
   ...
   */
		...
		$(document).on('click', cssTrigger, onExpandTriggerClick).on('click', '.js-popup-close', closeAllExpands);
	})(jQuery);
...
/***/function (module, exports) {
   ...
   */
		...
		var Subscribe = function (_FormValidation) {
			_inherits(Subscribe, _FormValidation);
     ...
     */
				...
				value: function _sendAjax(data) {
					...
					$.ajax({
						...
						$('.i-done').addClass('flag-active');
						$('.btn-subscribe').hide();

						setTimeout(function () {
							$('.btn-subscribe').show();
							$('.i-done').removeClass('flag-active');
						}, 5000);
						_this6.$form[0].reset();
